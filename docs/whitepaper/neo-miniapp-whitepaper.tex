...
\midrule
PaymentHub & \texttt{NLyxAiXdbc7pvckLw8aHpEiYb7P7NYHpQq} \\
Governance & \texttt{NeEWK3vcVRWJDebyBCyLx6HSzJZSeYhXAt} \\
PriceFeed & \texttt{Ndx6Lia3FsF7K1t73F138HXHaKwLYca2yM} \\
RandomnessLog & \texttt{NWkXBKnpvQTVy3exMD2dWNDzdtc399eLaD} \\
AppRegistry & \texttt{NX25pqQJSjpeyKBvcdReRtzuXMeEyJkyiy} \\
AutomationAnchor & \texttt{NNWqgxGnXGtfK7VHvEqbdSu3jq8Pu8xkvM} \\
ServiceLayerGateway & \texttt{NPXyVuEVfp47Abcwq6oTKmtwbJM6Yh965c} \\
\bottomrule
\end{tabular}
