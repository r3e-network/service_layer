...
**Goal:** Decouple miniapps from the platform by moving `miniapps-uniapp` to a dedicated repo, routing all apps through the external submission pipeline with auto-approve/auto-build for internal apps, and publishing `@r3e/uniapp-sdk` to npm.
...
## Task 1: Move `@r3e/uniapp-sdk` into platform repo and prep npm publish

**Files:**
- Move: `miniapps-uniapp/packages/@r3e/uniapp-sdk` -> `packages/@r3e/uniapp-sdk`
...
Create `packages/@r3e/uniapp-sdk/__tests__/exports.test.ts`:
...
```bash
git add packages/@r3e/uniapp-sdk pnpm-workspace.yaml docs/sdk-guide.md docs/getting-started/Quick-Start.md platform/host-app/docs/SDK.md platform/host-app/docs/README.md
...
## Task 7: Add npm publish workflow for @r3e/uniapp-sdk
...
Add `packages/@r3e/uniapp-sdk/__tests__/package-json.test.ts`:
...
Run: `cd packages/@r3e/uniapp-sdk && pnpm vitest run __tests__/package-json.test.ts`
...
```bash
git add packages/@r3e/uniapp-sdk .github/workflows/publish-uniapp-sdk.yml
