...
{
    public delegate void PredictResultHandler(UInt160 player, bool won, BigInteger payout);

    [DisplayName("MiniAppPricePredict")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Version", "1.0.0")]
    [ManifestExtra("Description", "Price Predict - Binary options trading")]
    [ContractPermission("*", "*")]
    public class MiniAppPricePredict : SmartContract
    {
        ...
        public static void Resolve(UInt160 player, bool won, BigInteger bet)
        {
            ...
            OnPredictResult(player, won, won ? bet * 190 / 100 : 0);
        }
