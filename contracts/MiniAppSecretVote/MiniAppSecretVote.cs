...
{
    public delegate void VoteCastHandler(UInt160 voter, string proposalId);

    [DisplayName("MiniAppSecretVote")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Version", "1.0.0")]
    [ManifestExtra("Description", "Secret Vote - Privacy-preserving voting")]
    [ContractPermission("*", "*")]
    public class MiniAppSecretVote : SmartContract
    {
        ...
        public static void CastVote(UInt160 voter, string proposalId)
        {
            ExecutionEngine.Assert(Runtime.CheckWitness(voter), "unauthorized");
            OnVoteCast(voter, proposalId);
        }
