...
.app-layout {
  ...
  display: flex;
  flex-direction: column;
  background: var(--bg-primary, #02040a);
  background-image:
    radial-gradient(circle at 50% 0%, rgba(159, 157, 243, 0.1) 0%, transparent 60%),
    radial-gradient(circle at 85% 30%, rgba(0, 229, 153, 0.05) 0%, transparent 40%),
