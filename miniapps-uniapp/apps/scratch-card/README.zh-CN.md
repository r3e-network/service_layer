...
| 属性 | 值 |
|------|-----|
| **合约地址** | `0x2674ef3b4d8c006201d1e7e473316592f6cde5f2` |
| **RPC 节点** | `https://testnet1.neo.coz.io:443` |
| **区块浏览器** | [在 NeoTube 查看](https://testnet.neotube.io/contract/0x2674ef3b4d8c006201d1e7e473316592f6cde5f2) |
| **网络魔数** | `894710606` |
