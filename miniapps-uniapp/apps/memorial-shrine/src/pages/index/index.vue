...
// Cemetery theme colors
$shrine-bg: #0a0d14;
$shrine-dark: #12161f;
$shrine-medium: #1a1f2e;
$shrine-gold: #c9a962;
$shrine-gold-light: #e6d4a8;
$shrine-text: #e8e6e3;
$shrine-muted: #6b6965;
...
.cemetery-bg {
  background: linear-gradient(180deg, $shrine-bg 0%, $shrine-dark 50%, $shrine-medium 100%);
  position: relative;
  ...
  &::before {
    ...
    right: 0;
    height: 200px;
    background: radial-gradient(ellipse at 80% 20%, rgba(255, 253, 232, 0.03), transparent);
    pointer-events: none;
  }
}
...
.header {
  ...
  .title {
    ...
    font-weight: 700;
    color: $shrine-gold;
    text-shadow: 0 0 30px rgba($shrine-gold, 0.3);
    margin-bottom: 8px;
  }
...
.obituary-banner {
  background: linear-gradient(90deg, $shrine-dark, $shrine-medium, $shrine-dark);
  border-radius: 12px;
  padding: 12px 16px;
  margin-bottom: 20px;
  border: 1px solid rgba($shrine-gold, 0.2);
