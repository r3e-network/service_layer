...
| 属性 | 值 |
|------|-----|
| **合约地址** | `0xfacff9abd201dca86e6a63acfb5d60da278da8ea` |
| **RPC 节点** | `https://testnet1.neo.coz.io:443` |
| **区块浏览器** | [在 NeoTube 查看](https://testnet.neotube.io/contract/0xfacff9abd201dca86e6a63acfb5d60da278da8ea) |
| **网络魔数** | `894710606` |
