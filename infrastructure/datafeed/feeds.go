...
// ArbitrumMainnetFeeds contains all Chainlink price feeds on Arbitrum One mainnet.
// Source: https://docs.chain.link/data-feeds/price-feeds/addresses?network=arbitrum
var ArbitrumMainnetFeeds = []FeedConfig{
...
// ArbitrumSepoliaFeeds contains Chainlink price feeds on Arbitrum Sepolia testnet.
var ArbitrumSepoliaFeeds = []FeedConfig{
...
func GetFeedsForNetwork(network string) []FeedConfig {
	switch network {
	case "arbitrum-mainnet", "arbitrum-one", "arbitrum":
		return ArbitrumMainnetFeeds
	case "arbitrum-sepolia", "arbitrum-testnet":
		return ArbitrumSepoliaFeeds
	default:
		return ArbitrumMainnetFeeds
	}
}
