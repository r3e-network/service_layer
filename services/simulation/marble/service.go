...
func (s *Service) startMiniAppWorkflows(ctx context.Context) int {
	workflowByAppID := map[string]func(context.Context) error{
		...
		"miniapp-quantum-swap":    s.miniAppSimulator.SimulateQuantumSwap,
		"miniapp-burn-league":     s.miniAppSimulator.SimulateBurnLeague,
		...
		"miniapp-scream-to-earn":  s.miniAppSimulator.SimulateScreamToEarn,

		// DeFi MiniApps (17)
		"miniapp-prediction-market":  s.miniAppSimulator.SimulatePredictionMarket,
		...
		"miniapp-dead-switch":        s.miniAppSimulator.SimulateDeadSwitch,
		...
		"miniapp-dark-pool":          s.miniAppSimulator.SimulateDarkPool,
		"miniapp-melting-asset":      s.miniAppSimulator.SimulateMeltingAsset,
		"miniapp-unbreakable-vault":  s.miniAppSimulator.SimulateUnbreakableVault,

		// Social MiniApps (14)
		"miniapp-secret-vote":    s.miniAppSimulator.SimulateSecretVote,
		...
		"miniapp-ai-soulmate":    s.miniAppSimulator.SimulateAISoulmate,
		"miniapp-dark-radio":     s.miniAppSimulator.SimulateDarkRadio,
		"miniapp-zk-badge":       s.miniAppSimulator.SimulateZKBadge,
		"miniapp-graveyard":      s.miniAppSimulator.SimulateGraveyard,
		"miniapp-bounty-hunter":  s.miniAppSimulator.SimulateBountyHunter,
		"miniapp-whisper-chain":  s.miniAppSimulator.SimulateWhisperChain,
		...
		"miniapp-nft-chimera":       s.miniAppSimulator.SimulateNFTChimera,
		...
		"miniapp-geo-spotlight":     s.miniAppSimulator.SimulateGeoSpotlight,
		"miniapp-world-piano":       s.miniAppSimulator.SimulateWorldPiano,
		...
		"miniapp-neo-chat":    s.miniAppSimulator.SimulateNeoChat,
