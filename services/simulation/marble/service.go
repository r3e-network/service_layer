...
func (s *Service) startMiniAppWorkflows(ctx context.Context) int {
	workflowByAppID := map[string]func(context.Context) error{
		...
		"builtin-quantum-swap":    s.miniAppSimulator.SimulateQuantumSwap,
		"builtin-burn-league":     s.miniAppSimulator.SimulateBurnLeague,
		"builtin-puzzle-mining":   s.miniAppSimulator.SimulatePuzzleMining,
		"builtin-fog-puzzle":      s.miniAppSimulator.SimulateFogPuzzle,
		"builtin-crypto-riddle":   s.miniAppSimulator.SimulateCryptoRiddle,
		"builtin-scream-to-earn":  s.miniAppSimulator.SimulateScreamToEarn,
		...
		"builtin-dead-switch":        s.miniAppSimulator.SimulateDeadSwitch,
		"builtin-heritage-trust":     s.miniAppSimulator.SimulateHeritageTrust,
		"builtin-compound-capsule":   s.miniAppSimulator.SimulateCompoundCapsule,
		"builtin-self-loan":          s.miniAppSimulator.SimulateSelfLoan,
		"builtin-dark-pool":          s.miniAppSimulator.SimulateDarkPool,
		"builtin-melting-asset":      s.miniAppSimulator.SimulateMeltingAsset,
		"builtin-unbreakable-vault":  s.miniAppSimulator.SimulateUnbreakableVault,
		...
		"builtin-ai-soulmate":    s.miniAppSimulator.SimulateAISoulmate,
		"builtin-dark-radio":     s.miniAppSimulator.SimulateDarkRadio,
		"builtin-zk-badge":       s.miniAppSimulator.SimulateZKBadge,
		"builtin-graveyard":      s.miniAppSimulator.SimulateGraveyard,
		"builtin-bounty-hunter":  s.miniAppSimulator.SimulateBountyHunter,
		"builtin-whisper-chain":  s.miniAppSimulator.SimulateWhisperChain,
		"builtin-dev-tipping":    s.miniAppSimulator.SimulateDevTipping,

		// Governance & NFT MiniApps (16)
		"builtin-gov-booster":       s.miniAppSimulator.SimulateGovBooster,
		"builtin-gov-merc":          s.miniAppSimulator.SimulateGovMerc,
		"builtin-masquerade-dao":    s.miniAppSimulator.SimulateMasqueradeDAO,
		"builtin-guardian-policy":   s.miniAppSimulator.SimulateGuardianPolicy,
		...
		"builtin-nft-chimera":       s.miniAppSimulator.SimulateNFTChimera,
		...
		"builtin-on-chain-tarot":    s.miniAppSimulator.SimulateOnChainTarot,
		"builtin-ex-files":          s.miniAppSimulator.SimulateExFiles,
		"builtin-breakup-contract":  s.miniAppSimulator.SimulateBreakupContract,
		"builtin-geo-spotlight":     s.miniAppSimulator.SimulateGeoSpotlight,
		"builtin-world-piano":       s.miniAppSimulator.SimulateWorldPiano,
		"builtin-million-piece-map": s.miniAppSimulator.SimulateMillionPieceMap,
		"builtin-canvas":            s.miniAppSimulator.SimulateCanvas,
		"builtin-candidate-vote":    s.miniAppSimulator.SimulateCandidateVote,
		"builtin-neoburger":         s.miniAppSimulator.SimulateNeoburger,
	}
