...
func TestVRFRequestStatusConstants(t *testing.T) {
...
func TestVRFRecordRoundTrip(t *testing.T) {
	...
	rec := vrfRecordFromReq(original)
	result := vrfReqFromRecord(rec)
...
// =============================================================================
// VRFRequest JSON Tests
// =============================================================================

func TestVRFRequestJSON(t *testing.T) {
	now := time.Now()
	req := VRFRequest{
		ID:               "id-123",
		RequestID:        "req-456",
