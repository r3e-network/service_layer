...
export default function BrowserScreen() {
  const { url: initialUrl, title } = useLocalSearchParams<{ url?: string; title?: string }>();
  ...
  // Auto-navigate if URL param provided (from MiniApps)
  useEffect(() => {
    if (initialUrl) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: title || "DApp Browser" }} />
