...
// Import translation files for validation (used in side-effects and type checking)
import _enCommon from "@/lib/i18n/locales/en/common.json";
import _zhCommon from "@/lib/i18n/locales/zh/common.json";
import _enHost from "@/lib/i18n/locales/en/host.json";
import _zhHost from "@/lib/i18n/locales/zh/host.json";
