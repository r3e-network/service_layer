/**
 * Neo N3 RPC Client
 * Direct communication with Neo N3 nodes.
 */
...
// rpcCall is the primary export for chain RPC calls
...
export { rpcCall as chainRpcCall, getBlockCount as getBlockCountMultiChain, getApplicationLog as getTransactionLogMultiChain };
