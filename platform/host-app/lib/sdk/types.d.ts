...
export type SecretsGetResponse = {
    name: string;
    value: string;
    version: number;
};
export type SecretsUpsertResponse = {
    secret: SecretMeta;
    created: boolean;
};
export type SecretsDeleteResponse = {
    status: "ok";
};
export type SecretsPermissionsResponse = {
    status: "ok";
    services: string[];
};
...
export type GasBankAccountResponse = {
    account: GasBankAccount;
};
export type GasBankDepositsResponse = {
    deposits: GasBankDeposit[];
};
export type GasBankTransactionsResponse = {
    transactions: GasBankTransaction[];
};
export type GasBankDepositCreateResponse = {
    deposit: GasBankDeposit;
};
