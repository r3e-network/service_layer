...
export default function EnhancedStatsPage() {
  ...
  const chainDistribution = stats?.chainDistribution || [
    { name: "Neo N3 Mainnet", value: 75, color: "#00e599" },
    { name: "Neo N3 Testnet", value: 25, color: "#9f9df3" },
  ];
...
function StatSummaryCard({ title, value, icon: Icon, color, loading, trend }: StatSummaryCardProps) {
  const getTrendIcon = () => {
