...
export function EmptyState({
  ...
  if (variant === "compact") {
    return (
      <div className={cn(
        ...
        <p className="text-sm font-medium text-erobo-ink-soft/70 dark:text-gray-400">
          {title}
        </p>
        {action && (
          <Button
            ...
            className="mt-2 text-erobo-purple"
          >
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-bold text-erobo-ink dark:text-white mb-2">
        {title}
      </h3>
      <p className="text-sm text-erobo-ink-soft/70 dark:text-gray-400 max-w-sm mb-6">
        {message}
      </p>
      {action && (
