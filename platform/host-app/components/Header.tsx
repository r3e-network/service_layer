...
export function Header({ wallet, onConnect }: Props) {
  return (
    <header className="sticky top-0 z-[100] flex justify-between items-center px-6 py-4 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-erobo-purple/10 dark:border-white/10 shadow-sm transition-all">
      <div className="flex items-center gap-3 group cursor-pointer">
        ...
        <span className="text-xl font-bold tracking-tight text-erobo-ink dark:text-white">
      ...
      <button
        ...
        className={`px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${wallet.connected
            ? "bg-erobo-purple/10 dark:bg-white/10 text-erobo-ink dark:text-slate-200 hover:bg-erobo-purple/15 dark:hover:bg-white/20"
