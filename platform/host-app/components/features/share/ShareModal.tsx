...
export function ShareModal({ isOpen, onClose, url, title, description = "", iconUrl, locale = "en" }: ShareModalProps) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[95vw] max-w-[420px] bg-white dark:bg-erobo-bg-card rounded-2xl shadow-2xl border border-white/10 dark:border-white/5 z-[10000] overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-black/5 dark:border-white/5">
              <div className="flex items-center gap-3">
                {iconUrl && <img src={iconUrl} alt="" className="w-8 h-8 rounded-lg" />}
                <div>
            ...
            <div className="flex border-b border-black/5 dark:border-white/5">
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-medium transition-colors ${
                  activeTab === "qr" ? "text-neo border-b-2 border-neo" : "text-muted-foreground hover:text-foreground"
                }`}
              >
            ...
            <div className="p-6">
              {activeTab === "link" ? (
                  ...
                  <div className="flex items-center gap-2 p-3 bg-black/5 dark:bg-white/5 rounded-xl">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                        copied ? "bg-neo text-black" : "bg-neo/20 text-neo hover:bg-neo hover:text-black"
                      }`}
                    >
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground text-center">{t.scanQR}</p>
