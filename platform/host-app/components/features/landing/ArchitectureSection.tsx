    ...
    <section className="py-24 px-4 bg-background relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left Content */}
          <div className="bg-white dark:bg-card/40 border border-gray-200 dark:border-white/10 p-10 rounded-3xl backdrop-blur-xl">
          ...
          <div className="relative pl-8">
            <div className="space-y-6 relative z-10">
              ...
              {/* Trust Root Card */}
              <div className="p-6 bg-white dark:bg-card/60 border border-gray-200 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-gray-300 dark:hover:border-white/20 hover:shadow-xl hover:shadow-red-500/5 group">
              ...
              {/* ServiceOS Card */}
              <div className="p-6 bg-white dark:bg-card/60 border border-gray-200 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-gray-300 dark:hover:border-white/20 hover:shadow-xl hover:shadow-neo/5 group">
                <div className="flex items-center gap-6">
              ...
              {/* Services Layer Card */}
              <div className="p-6 bg-white dark:bg-card/60 border border-gray-200 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-gray-300 dark:hover:border-white/20 hover:shadow-xl hover:shadow-yellow-500/5 group">
                <div className="flex items-center gap-6">
