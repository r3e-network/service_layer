      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 p-10 rounded-3xl backdrop-blur-xl shadow-2xl">
            ...
            <p className="text-lg text-erobo-ink-soft dark:text-white/60 mb-10 leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {FEATURES.map((feature, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-4 p-4 border border-erobo-purple/10 dark:border-white/5 bg-erobo-purple/5 dark:bg-white/5 rounded-xl transition-all hover:bg-erobo-purple/10 dark:hover:bg-white/10 hover:border-erobo-purple/20 dark:hover:border-white/10 group"
                >
                  ...
                  <h4 className="text-sm font-bold text-erobo-ink dark:text-white tracking-wide">
          ...
          <div className="relative pl-8">
            <div className="space-y-6 relative z-10">
              ...
              {/* Trust Root Card */}
              <div className="p-6 bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-erobo-purple/20 dark:hover:border-white/20 hover:shadow-xl hover:shadow-red-500/5 group">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-erobo-ink dark:text-white mb-1 group-hover:text-red-400 transition-colors">
                      {t("landing.architecture.teeTitle")}
                    </h4>
                    <p className="text-sm font-medium text-erobo-ink-soft dark:text-white/50">
              ...
              {/* ServiceOS Card */}
              <div className="p-6 bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-erobo-purple/20 dark:hover:border-white/20 hover:shadow-xl hover:shadow-neo/5 group">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-erobo-ink dark:text-white mb-1 group-hover:text-neo transition-colors">
              ...
              {/* Services Layer Card */}
              <div className="p-6 bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-2xl backdrop-blur-md shadow-lg transition-transform hover:-translate-y-1 hover:border-erobo-purple/20 dark:hover:border-white/20 hover:shadow-xl hover:shadow-yellow-500/5 group">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-erobo-ink dark:text-white mb-1 group-hover:text-yellow-400 transition-colors">
