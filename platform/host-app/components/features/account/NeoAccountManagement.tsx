...
export function NeoAccountManagement({ walletAddress }: NeoAccountManagementProps) {
  ...
  return (
    <Card className="rounded-2xl bg-white/50 dark:bg-black/40 backdrop-blur-sm border-erobo-purple/10 dark:border-white/10 shadow-sm">
      ...
      <CardContent className="pt-8 space-y-6">
        ...
        <div className="p-4 rounded-xl bg-erobo-purple/5 dark:bg-white/5 border border-erobo-purple/10 dark:border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex-1 min-w-0">
              <p className="text-xs font-bold uppercase tracking-wider text-erobo-ink-soft dark:text-slate-400 mb-1">
                {t("account.neo.currentAddress") || "Current Address"}
              </p>
              <p className="text-sm font-mono font-medium text-erobo-ink dark:text-white truncate">
                {walletAddress || "—"}
              </p>
            </div>
          </div>
        ...
        {/* Info Message */}
        <div className="p-4 rounded-xl bg-blue-50 dark:bg-erobo-purple/10 border border-blue-200 dark:border-blue-500/20">
