...
const CHAIN_DISPLAY: Record<ChainId, { name: string; icon: string; color: string }> = {
  ...
  "neox-mainnet": { name: "NeoX", icon: "/chains/neox.svg", color: "text-purple-500" },
  "neox-testnet": { name: "NeoX Testnet", icon: "/chains/neox.svg", color: "text-purple-500" },
  "ethereum-mainnet": { name: "Ethereum", icon: "/chains/ethereum.svg", color: "text-blue-500" },
  "ethereum-sepolia": { name: "Sepolia", icon: "/chains/ethereum.svg", color: "text-blue-500" },
};
