...
const APP_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  "miniapp-compoundcapsule": VaultIcon,
  "miniapp-selfloan": FlashLoanIcon,
  ...
  "miniapp-devtipping": HeartIcon,
  "miniapp-breakupcontract": HeartIcon,
  "miniapp-timecapsule": TimeCapsuleIcon,
  ...
  "miniapp-gardenofneo": CanvasIcon,
  ...
  "miniapp-govmerc": GovernanceIcon,
  "miniapp-burnleague": GovernanceIcon,
  "miniapp-doomsdayclock": GovernanceIcon,
  ...
  "miniapp-heritagetrust": VaultIcon,
