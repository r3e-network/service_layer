...
```json
{
    ...
    "detected": {
        "manifest": true,
        "assets": { "icon": ["static/icon.png"], "banner": ["static/banner.jpg"] },
        "build_type": "vite",
        "build_config": {
...
| 类型       | 搜索路径                                                     |
| ---------- | ------------------------------------------------------------ |
| Icon       | `icon.png`, `logo.jpg`, `app-icon.png`, `static/icon.png` 等 |
| Banner     | `banner.jpg`, `app-banner.jpg`, `static/banner.jpg` 等       |
