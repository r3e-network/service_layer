  ...
  return (
    <div className={styles.section}>
      <div className={styles.header}>
        ...
        <button onClick={fetchProposals} className={styles.buttonSecondary} disabled={loading}>
      ...
      <div className={styles.proposalList}>
              ...
              <div>
                ...
                <div className={styles.proposalMeta}>
                  ...
                  <span className={styles.metaItem}>
                    {new Date(p.offchain_creation_timestamp).toLocaleDateString()}
                  </span>
                  <a href={p.discussion_url} target="_blank" rel="noreferrer" className={styles.discussionLink}>
        ...
        {!loading && proposals.length === 0 && !error && <div className={styles.emptyState}>No proposals found.</div>}
      </div>
    </div>
  );
}
