...
title: { en: "Neo Swap", zh: "Neo 兑换" },
  ...
  docDescription: {
    en: "Neo Swap provides direct swaps between NEO and GAS. Prices are fetched via the data feed and swaps execute through Flamingo's on-chain router.",
    zh: "Neo Swap 提供 NEO 与 GAS 的直接兑换。价格通过数据源获取，交易通过 Flamingo 的链上路由执行。",
  },
  step1: {
  ...
  feature3Desc: {
    en: "Swaps execute via Flamingo's on-chain router contract.",
