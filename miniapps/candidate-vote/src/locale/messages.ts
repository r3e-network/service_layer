...
const appMessages = {
  ...
  docDescription: {
    en: "Vote for Neo N3 consensus node candidates using the native governance contract. Your NEO balance determines voting power, and results update on-chain with each vote.",
    zh: "通过原生治理合约为 Neo N3 共识节点候选人投票。您的 NEO 余额决定投票权重，每次投票都会在链上更新结果。",
  },
  ...
  feature3Name: { en: "Candidate Insights", zh: "候选人信息" },
  feature3Desc: { en: "Review candidate details and vote totals before voting.", zh: "投票前可查看候选人详情与票数。" },
  ...
  ariaCandidates: { en: "Candidates", zh: "候选人" },
  none: { en: "None", zh: "无" },
} as const;
