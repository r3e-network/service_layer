...
namespace NeoMiniAppPlatform.Contracts
{
    public partial class MiniAppTimeCapsule
    {
        ...
        public static BigInteger Bury(UInt160 owner, string contentHash, string title, BigInteger unlockTime, bool isPublic, BigInteger category, BigInteger receiptId)
        {
            ...
            BigInteger lockDuration = unlockTime - (BigInteger)Runtime.Time;
            ...
            CapsuleData capsule = new CapsuleData
            {
                ...
                CreateTime = (BigInteger)Runtime.Time,
                IsPublic = isPublic,
                IsRevealed = false,
            ...
            Storage.Put(Storage.CurrentContext,
                Helper.Concat(PREFIX_HASH_INDEX, contentHash.ToByteArray()), capsuleId);
            ...
            UpdateUserStatsOnBury(owner, category, BURY_FEE);
