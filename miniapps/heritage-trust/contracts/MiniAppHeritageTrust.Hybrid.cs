...
namespace NeoMiniAppPlatform.Contracts
{
    public partial class MiniAppHeritageTrust
    {
        ...
        public static Map<string, object> GetTrustRaw(BigInteger trustId)
        {
            ...
            data["gasPrincipal"] = trust.GasPrincipal;
            data["accruedYield"] = trust.AccruedYield;
            data["claimedYield"] = trust.ClaimedYield;
            data["monthlyNeo"] = trust.MonthlyNeoRelease;
            data["monthlyGas"] = trust.MonthlyGasRelease;
            data["onlyRewards"] = trust.OnlyReleaseRewards;
            data["releaseMode"] = ResolveReleaseMode(trust);
            data["lastReleaseTime"] = trust.LastReleaseTime;
            data["totalNeoReleased"] = trust.TotalNeoReleased;
            data["totalGasReleased"] = trust.TotalGasReleased;
